...
\begin{figure}[h!]
\begin{center}
\subfloat{\includegraphics[width=0.49\textwidth]{Images/controlplots/lep1_e_vbf}}
\subfloat{\includegraphics[width=0.49\textwidth]{Images/controlplots/lep2_e_vbf}}\\
\subfloat{\includegraphics[width=0.49\textwidth]{Images/controlplots/tauh_sv_e_vbf}}
\subfloat{\includegraphics[width=0.49\textwidth]{Images/controlplots/tauh_sv_eta_vbf}}\\
\subfloat{\includegraphics[width=0.49\textwidth]{Images/controlplots/vbfjet1_eta_vbf}}
\subfloat{\includegraphics[width=0.49\textwidth]{Images/controlplots/vbfjet2_eta_vbf}}\\
\end{center}
