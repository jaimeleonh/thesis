...
\end{tabular}
\end{center}
\caption[Trigger selections applied in the analysis split by channel and year]{Trigger selections applied in the analysis split by channel and year.}
\label{hh:tab:triggers}
\end{table}

Each reconstructed offline object is required to geometrically match (within $\Delta R < 0.5$) their corresponding trigger object and also pass a $p_T$ threshold depending on the HLT trigger path fired by the event,
\begin{equation}
...
\end{tabular}
\end{center}
\caption[Offline selection for the \taumu\tauh{} final state]{Offline selection for the \taumu\tauh{} final state.}
...
\end{tabular}
\end{center}
\caption[Offline selection for the \taue\tauh{} final state]{Offline selection for the \taue\tauh{} final state.}
...
\end{tabular}
\end{center}
\caption[Offline selection for the \tauh\tauh{} final state]{Offline selection for the \tauh\tauh{} final state.}
...
\begin{figure}[h]
\begin{center}
\subfloat[]{\includegraphics[width=0.33\textwidth]{Images/lep1_eta__mutau_os_iso__qcd__stack}}
\subfloat[]{\includegraphics[width=0.33\textwidth]{Images/lep1_eta__etau_os_iso__qcd__stack}}
\subfloat[]{\includegraphics[width=0.33\textwidth]{Images/lep1_eta__tautau_os_iso__qcd__stack}}
\end{center}
